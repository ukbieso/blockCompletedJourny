...
/** Key partition of an actual block. */
@org.apache.avro.specific.AvroGenerated
public class ActualBlockKeyV1 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4204566864710277651L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ActualBlockKeyV1\",\"namespace\":\"no.ruter.avro.entity.actual.block.key\",\"doc\":\"Key partition of an actual block.\",\"fields\":[{\"name\":\"Timestamp\",\"type\":\"string\",\"doc\":\"Timestamp as close to the actual event that changed the entity in ISO format. Ex. GPS timestamp\"},{\"name\":\"TraceID\",\"type\":\"string\",\"doc\":\"Identify the a transaction uniquely across multiple changes in entities and commands. If a change in an entity is done as a consequence of a change in another entity partition or a command the traceID is copyed from that record. Otherwise a new unique UUID is created.\"},{\"name\":\"OriginID\",\"type\":\"string\",\"doc\":\"Identify the originating senderID of a transaction across multiple changes in entities and commands. If a change in an entity is done as a consequence of a change in another entity partition or a command the senderID is copyed from that record. Otherwise same value as in senderID is used.\"},{\"name\":\"SenderID\",\"type\":\"string\",\"doc\":\"Identify the creator of this change to the entity partition\"},{\"name\":\"Name\",\"type\":\"string\",\"doc\":\"This identify the actual block entity and should always be set to 'actualblock' in this schema\",\"default\":\"actualblock\"},{\"name\":\"Partition\",\"type\":\"string\",\"doc\":\"This identify the entity partition and should always be set to 'key' in this schema\",\"default\":\"key\"},{\"name\":\"Version\",\"type\":\"int\",\"doc\":\"This identifiy the version of the schema and sould always be set to 1 in this schema\",\"default\":1},{\"name\":\"EntityPartition\",\"type\":{\"type\":\"record\",\"name\":\"EntityPartition\",\"doc\":\"The data of the entity partition\",\"fields\":[{\"name\":\"Key\",\"type\":\"string\",\"doc\":\"The key of an entity. All entities must use the key attribute to store their primary key\"},{\"name\":\"BlockRef\",\"type\":\"string\",\"doc\":\"Reference to  block this actual block is on.\"},{\"name\":\"VehicleRef\",\"type\":\"string\",\"doc\":\"Reference to the vehicle delivering this actual block.\"},{\"name\":\"lastActualJourneyRef\",\"type\":[\"null\",\"string\"],\"doc\":\"Reference to the last actual journey on block\",\"default\":null}]},\"doc\":\"The data of the entity partition\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<ActualBlockKeyV1> ENCODER =
      new BinaryMessageEncoder<ActualBlockKeyV1>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<ActualBlockKeyV1> DECODER =
      new BinaryMessageDecoder<ActualBlockKeyV1>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<ActualBlockKeyV1> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ActualBlockKeyV1> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ActualBlockKeyV1>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this ActualBlockKeyV1 to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a ActualBlockKeyV1 from a ByteBuffer. */
  public static ActualBlockKeyV1 fromByteBuffer(
  ...
  /** This identify the actual block entity and should always be set to 'actualblock' in this schema */
  ...
  @Deprecated public no.ruter.avro.entity.actual.block.key.EntityPartition EntityPartition;
   ...
   * @param Name This identify the actual block entity and should always be set to 'actualblock' in this schema
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 7: EntityPartition = (no.ruter.avro.entity.actual.block.key.EntityPartition)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return This identify the actual block entity and should always be set to 'actualblock' in this schema
   */
   ...
   */
  public no.ruter.avro.entity.actual.block.key.EntityPartition getEntityPartition() {
   ...
   * @param value the value to set.
   */
  public void setEntityPartition(no.ruter.avro.entity.actual.block.key.EntityPartition value) {
    this.EntityPartition = value;
  }

  /**
   * Creates a new ActualBlockKeyV1 RecordBuilder.
   * @return A new ActualBlockKeyV1 RecordBuilder
   */
  public static no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder newBuilder() {
    return new no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder();
  }

  /**
   * Creates a new ActualBlockKeyV1 RecordBuilder by copying an existing Builder.
   ...
   * @return A new ActualBlockKeyV1 RecordBuilder
   */
  public static no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder newBuilder(no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1 other) {
    return new no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder(other);
  }

  /**
   * RecordBuilder for ActualBlockKeyV1 instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ActualBlockKeyV1>
    implements org.apache.avro.data.RecordBuilder<ActualBlockKeyV1> {
    ...
    private int Version;
    /** The data of the entity partition */
    private no.ruter.avro.entity.actual.block.key.EntityPartition EntityPartition;
    private no.ruter.avro.entity.actual.block.key.EntityPartition.Builder EntityPartitionBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder other) {
      super(other);
      ...
      if (other.hasEntityPartitionBuilder()) {
        this.EntityPartitionBuilder = no.ruter.avro.entity.actual.block.key.EntityPartition.newBuilder(other.getEntityPartitionBuilder());
      }
    }

    /**
     * Creates a Builder by copying an existing ActualBlockKeyV1 instance
     * @param other The existing instance to copy.
     */
    private Builder(no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1 other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.Timestamp)) {
        this.Timestamp = data().deepCopy(fields()[0].schema(), other.Timestamp);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder setTimestamp(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder clearTimestamp() {
      Timestamp = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder setTraceID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder clearTraceID() {
      TraceID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder setOriginID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder clearOriginID() {
      OriginID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder setSenderID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder clearSenderID() {
      SenderID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder clearName() {
      Name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder clearPartition() {
      Partition = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder setVersion(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder clearVersion() {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder setEntityPartition(no.ruter.avro.entity.actual.block.key.EntityPartition value) {
     ...
     * @return This builder.
     */
    public no.ruter.avro.entity.actual.block.key.EntityPartition.Builder getEntityPartitionBuilder() {
      if (EntityPartitionBuilder == null) {
        if (hasEntityPartition()) {
          setEntityPartitionBuilder(no.ruter.avro.entity.actual.block.key.EntityPartition.newBuilder(EntityPartition));
        } else {
          setEntityPartitionBuilder(no.ruter.avro.entity.actual.block.key.EntityPartition.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder setEntityPartitionBuilder(no.ruter.avro.entity.actual.block.key.EntityPartition.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.ruter.avro.entity.actual.block.key.ActualBlockKeyV1.Builder clearEntityPartition() {
    ...
    public ActualBlockKeyV1 build() {
      try {
        ActualBlockKeyV1 record = new ActualBlockKeyV1();
        ...
        if (EntityPartitionBuilder != null) {
          ...
          record.EntityPartition = fieldSetFlags()[7] ? this.EntityPartition : (no.ruter.avro.entity.actual.block.key.EntityPartition) defaultValue(fields()[7]);
        }
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ActualBlockKeyV1>
    WRITER$ = (org.apache.avro.io.DatumWriter<ActualBlockKeyV1>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ActualBlockKeyV1>
    READER$ = (org.apache.avro.io.DatumReader<ActualBlockKeyV1>)MODEL$.createDatumReader(SCHEMA$);
